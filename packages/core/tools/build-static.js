...
//   - lexicon.json: the merged lexicon (base + L0003) — already merged in src/lexicon.ts.
...
// 1. lexicon — merged (base + L0003) as plain JSON in lexicon.json. No lexicon.js is written:
